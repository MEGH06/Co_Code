...
function Quizard({ onBack, onPanicNotes, onCramBot, currentView }) {
  ...
  return (
    <div className="main-content">
      ...
      <div className="features">
        <div className="feature-card pink clickable" onClick={onPanicNotes}>
...
<path d="M68.7,44.9c-6.6-0.7-12.9-1-19-1c-6.1,0-12.5,0.3-19,1h0c-2.2,0.2-3.8,2.2-3.5,4.3l2,19.4
	...
	s1.3-3.7,2.8-3.7s2.8,1.6,2.8,3.7S62.2,62.5,60.6,62.5z"/>
        ...
        <div className="feature-card purple-light active">
